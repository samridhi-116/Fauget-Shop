  ...
  return (
    <div className='w-11/12 mx-auto bg-white my-6 px-6 py-4'>
        <div className='w-full flex flex-col justify-center items-center'>
            ...
            <p className=' text-lg font-sans font-bold leading-loose mt-4 text-center'>Your cart is empty!</p>
            <p className='text-center text-sm font-normal font-sans text-gray-500 leading-relaxed'>Looks like you have not added anything to your cart. Go <br/> ahead and explore top categories</p>
            <Link to='/'>
